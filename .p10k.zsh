# Generated by Powerlevel10k configuration wizard on 2020-08-19 at 16:59 CST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 15764.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 12h time, slanted separators, blurred heads, slanted tails, 2 lines, dotted,
# right frame, dark-ornaments, sparse, many icons, concise, instant_prompt=quiet.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='%F{226}❯%F{174}❯%F{48}❯'

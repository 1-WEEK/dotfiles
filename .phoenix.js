...
// Launch App
// keys.push(new Key('1', mash, function() { callApp('iTerm'); }));
// keys.push(new Key('2', mash, function() { callApp('Google Chrome'); }));
// keys.push(new Key('3', mash, function() { callApp('Visual Studio Code'); }));
// keys.push(new Key('4', mash, function() { callApp('Spark'); }));
// keys.push(new Key('5', mash, function() { callApp('NeteaseMusic'); }));
// keys.push(new Key('7', mash, function() { callApp('CCtalk'); }));
// keys.push(new Key('8', mash, function() { callApp('QQ'); }));
// keys.push(new Key('9', mash, function() { callApp(''); }));
